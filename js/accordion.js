...
//   const allAccordionButton = accordion.querySelectorAll('.accordion__btn');
...
//       collapseElement.setAttribute('id', 'accordion__collapse');
//     });
//     const accordionButton = event.target.closest('.accordion__btn');
...
//       allAccordionButton.forEach(buttonElement => {
//         buttonElement.classList.remove("accordion__btn_active");
//         buttonElement.setAttribute('aria-expanded', 'false')
//       });
//       // Add active class to the clicked button
//       accordionButton.classList.add('accordion__btn_active');
...
//       accordionButton?.classList.remove('accordion__btn_active');
...
class Accordion {
  constructor(accordionElem, options) {
    ...
    this.allAccordionButton = this.accordion.querySelectorAll('.accordion__btn');
